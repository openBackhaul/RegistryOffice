...
exports.getHttpServerApplicationName = function(uuid) {
  ...
  "http-server-interface-1-0:application-name" : "RegistryOffice"
};
...
exports.getHttpServerApplicationPurpose = function(uuid) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = {
  "http-server-interface-1-0:application-purpose" : "All applications being part of the MBH SDN must be register here."
};
    if (Object.keys(examples).length > 0) {
      resolve(examples[Object.keys(examples)[0]]);
    } else {
