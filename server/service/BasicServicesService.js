...
exports.informAboutApplicationInGenericRepresentation = function(user,originator,xCorrelator,traceIndicator,customerJourney) {
  ...
  "response-value-list" : [ {
    ...
    "value" : "All applications being part of the MBH SDN must be register here.",
    "datatype" : "String"
  }, {
    ...
    "forwarding-domain" : [ {
      ...
      "forwarding-construct" : [ {
        ...
        "fc-port" : [ {
          ...
          "logical-termination-point" : "ro-0-0-1-op-s-0000"
        }, {
          "local-id" : "100",
        ...
        "fc-port" : [ {
          "local-id" : "100",
          "port-direction" : "core-model-1-4:PORT_DIRECTION_TYPE_INPUT",
          "logical-termination-point" : "ro-0-0-1-op-s-0001"
        }, {
          "local-id" : "200",
          "port-direction" : "core-model-1-4:PORT_DIRECTION_TYPE_OUTPUT",
          "logical-termination-point" : "ro-0-0-1-op-c-0020"
        } ]
      } ]
    } ],
    "logical-termination-point" : [ {
      "uuid" : "ro-0-0-1-op-s-0000",
...
/**
 * Initiates announcing of a new release of the RegistryOffice to the currently active RegistryOffice
